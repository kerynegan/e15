...
<form method='POST' action='/courses/{{$course->id}}/save'  >
 ...
 <br />
    ...
    @else
        ...
        <textarea name='proposed_title' dusk='proposed_title' id='proposed_title' rows="2" cols="40" value='' >{{ $course->title }}</textarea><br />
...
<br />
    ...
    @endif
        ...
        <input type='radio' name='proposed_format' id='flex-conference' value='Live or on-demand web conference' >
...
<br />
    ...
    @endif
        <textarea name='proposed_course_description' id='proposed_course_description' dusk='proposed_course_description' rows="7" cols="60" value=''>{{ $course->description }}</textarea><br />
...
<br />
    ...
    @endif
        <textarea name='proposed_prerequisite' id='proposed_prerequisite' dusk='proposed_prerequisite' rows="7" cols="60" value=''>{{ $course->prerequisite }}</textarea><br />
...
<br />
    ...
    @endif
        <textarea name='proposed_note' id='proposed_note' dusk='proposed_note'rows="7" cols="60" value=''>{{ $course->note }}</textarea><br />
...
<br />
    ...
    @endif
        <textarea name='proposed_section_note' id='proposed_section_note' dusk='proposed_section_note' rows="7" cols="60" value=''>{{ $course->section_note }}</textarea><br />
